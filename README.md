...
- [chimeric-mitochondrial-RNA-analysis](#chimeric-mitochondrial-rna-analysis)
  ...
  - [Analysis procedure](#analysis-procedure)
    - [Prepare STAR-Fusion reference files](#prepare-star-fusion-reference-files)
      - [Download rat reference genome information from Ensembl](#download-rat-reference-genome-information-from-ensembl)
      ...
      - [Download human reference genome information from Ensembl](#download-human-reference-genome-information-from-ensembl)
