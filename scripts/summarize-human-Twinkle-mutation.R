...
input_folder <- 'star-fusion-results/human-Twinkle-mutation' 
metadata_folder <- 'SRA-metadata/human-Twinkle-mutation'
output_folder <- 'star-fusion-results-summary/human-Twinkle-mutation'
pca_color_by <- 'genotype'
